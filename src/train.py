...
parser.add_argument('--latent-dim', type=int, default=32, help='???')
...
parser.add_argument('--k-iwae', type=int, default=10, help='???')
parser.add_argument('--save', action='store_true', help='Flag for saving trained model.')
parser.add_argument('--seed', type=int, default=0, help='Seed for random number generator.')
parser.add_argument('--n', type=int, default=8000, help='???')
...
parser.add_argument('--kl-zero', action='store_true', help='???')
...
parser.add_argument('--net', type=str, default='hetvae', help='???')
...
parser.add_argument('--sample-tp', type=float, default=0.5, help='How many timepoints to be sampled. Fraction value between (0,1] .')
parser.add_argument('--bound-variance', action='store_true', help='???')
parser.add_argument('--shuffle', action='store_true', help='???')
parser.add_argument('--recon-loss', action='store_true', help='???')
...
parser.add_argument('--mixing', type=str, default='concat', help='???')
